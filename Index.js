...
henter1357:["STOP","im so gay focks SGER im not A ROACH!!!!!","im reely matur ackchully, i respeckt opinsdos a lot","HOW DARE YOU INSULT GOANIMATE  NIG"],
jabb: ["OH OH OH OH OH OH, you are is GROUNDINGS FOR 10000 inches per square meter","hahahahah you got the loic ddos by bonziONUTE samsung fanclub","youre the of HOOLIGAN AND david EGANS HATER!!!!!"],
celepota:["EUROPE IS BAD DONT MAKE FUN OF JEWS!!!!!","ahhahhahah ur poor only 5g im rich and i flex 4g and you cant i even flex iphones and androids im obsesed with them 95943g epik","i hlove europe slow 1mpgs its faster than 5g  internet turkey best"],
...
var retards = ["put some here"];
bot.on('ready', ()=>{

console.log("its online");
bot.user.setActivity("you can put what ever you want here ");
});
...
message.channel.send("you are is speedtests of cellpot, the turkcell cellpot verizion 5g on your iphone 13 pro max 5g and your iphone 12 pro max 5g is are "+rand+ " BYTES PER INCH. VERY OF SPEEDS INTERNET");
} else{

message.channel.send("you are is speedtests of cellpot, the turkcell 5g is are "+rand+ " BYTES PER INCH. hahaha you are is poor cellpot is poor and uses 4g and klasky has 5g.");
}
} else if(comd == "admin"){
...
spammsg();
    ...
    message.channel.send("its gotta be more than 0 and less than or equal to 15000");
}
        }
    } else{
